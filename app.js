document.addEventListener('DOMContentLoaded', () => {
    ...
    // to start, and to restart a game
    function startGame() {
    ...
    // generate a new apple once an apple has been eaten
    function randomApple() {
        do {
            appleIndex = Math.floor(Math.random() * squares.length)
        } while (squares[appleIndex].classList.contains('snake')) // making sure the apple doesn't appear in the div with snake
    ...
    function control(e) {
        ...
        if (e.keyCode === 39) {
            direction = 1 // if we press the right arrow on our keyboard, the snake will go right 1 unit
